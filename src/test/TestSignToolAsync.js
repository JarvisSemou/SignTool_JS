...
let sign = await SignTool.genSign(SignType.Department_Id_And_Token, {
...
sign = await SignTool.genSign(SignType.Department_Id_And_Token, {
    departmentId: "departmentId",
    token: "aaaaaaaaaa",
    timestamp: "timestamp"
})
...
sign = await SignTool.genSign(SignType.Enterprise_Id_And_Token, {
...
sign = await SignTool.genSign(SignType.Department_Id_And_CrmId_And_Password, {
    departmentId: "departmentId",
    crmId: "crmId",
    password: "password"
})
...
sign = await SignTool.genSign(SignType.Enterprise_Id_And_CrmId_And_Password, {
    enterpriseId: "enterpriseId",
    crmId: "crmId",
    password: "password"
})
...
sign = await SignTool.genSign(SignType.Department_Id_And_Cno_And_AgentToken, {
    departmentId: "departmentId",
    cno: "cno",
...
sign = await SignTool.genSign(SignType.Enterprise_Id_And_Cno_And_AgentToken, {
    enterpriseId: "enterpriseId",
    cno: "cno",
    agentToken: "agentToken",
})
